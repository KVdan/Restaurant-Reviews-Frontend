...
const RestaurantsList = (props) => {
  ...
  return (
    <div>
      <Container id="searcherContainer" maxWidth="md">
        <Grid container spacing={1}>
          <Grid item xs={12} md={4}>
            <Autocomplete
              ...
              style={{ width: 210 }}
              renderInput={(params) => (
                <TextField {...params} label="Search by Cuisine" />
              )}
            />
          </Grid>
          <Grid item xs={12} md={4}>
      ...
      <Container id="paginationContainer" maxWidth="md">
        <p> Jump to page </p>
        <div
          className="d-flex flex-row bd-highlight mb-3"
          style={{ height: 40 }}
        >
          <button className="h-100 d-inline-block" onClick={jumpToPage0}>
            Zero
          </button>
          {restaurants &&
            (currentPage < 3
          ...
          {currentPage + 3 < [...pageArr].pop() && (
            <div>
              <button className="h-100 d-inline-block" disabled>
                ...
              </button>
              <button className="h-100 d-inline-block" onClick={jumpToPage}>
      ...
      <Container id="contentContainer" maxWidth="sm">
